...
class DownloadFrame:
    ...
    def MyUiLayout(self):
        ...
        self.downloadState = wx.StaticText(self.panel, wx.ID_ANY, "等待下载",size=(80, 20))
        downloadSizer.Add(self.downloadState, 0, flag=wx.RIGHT | wx.LEFT, border=8)
...
class MyFrame(wx.Frame):
    def __init__(self):
        ...
        """
        self.downloadAll = [self.downloadOne]
    ...
    def onBtnDownload(self,event):
        ...
        for downloadTemp in self.downloadAll:
            ...
            if downloadTemp.serialSelect.GetValue():
                downloadTemp.downloadState.SetForegroundColour(wx.BLACK)
                self.downloadOne.downloadState.SetLabelText("下载中......")
        ...
        if DOWNLOAD_EVT_OVER == param[0]:
            ...
            for downloadTemp in self.downloadAll:
                if downloadTemp.serialSelect.GetValue() == param[1]:
                    ...
                    downloadTemp.downloadState.SetForegroundColour(wx.BLUE)
                    downloadTemp.downloadState.SetLabelText("下载成功")
            ...
            for downloadTemp in self.downloadAll:
                if downloadTemp.serialSelect.GetValue() == param[1]:
                    ...
                    downloadTemp.downloadState.SetForegroundColour(wx.RED)
                    downloadTemp.downloadState.SetLabelText("下载失败")
