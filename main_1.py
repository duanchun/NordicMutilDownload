...
class MyFrame(wx.Frame):
    ...
    def targetFileSelect(self):
        ...
        # Process Bar
        self.processBarOne = wx.Gauge(self.panel,range=TASK_RANGE, size=(350, 20))
        #self.processBarOne.SetValue(TASK_RANGE-1)
        #self.processBarOne.SetBackgroundColour(wx.BLACK)
    ...
    def onBtnDownload(self,event):
        ...
        self.processBarOne.SetBackgroundColour(wx.GREEN)
        self.processBarTwo.SetBackgroundColour(wx.GREEN)
